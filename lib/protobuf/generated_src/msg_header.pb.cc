...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ClientMsgHeader_msg_5fheader_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsscc_info_ClientMsgHeader_msg_5fheader_2eproto}, {}};
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 14, -1, sizeof(::msg_header::ServerMsgHeader)},
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_msg_5fheader_2eproto = {
  &descriptor_table_msg_5fheader_2eproto_initialized, descriptor_table_protodef_msg_5fheader_2eproto, "msg_header.proto", 173,
